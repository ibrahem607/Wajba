...
namespace Wajba.Migrations
{
    ...
    [Migration("20241212011041_addoofercouponitemtaxtables")]
    partial class addoofercouponitemtaxtables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wajba.BranchDomain.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.CategoriesDomain.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.CouponsDomain.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.CurrenciesDomain.Currencies", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.ItemAddonDomain.ItemAddon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.ItemAttributeDomain.ItemAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.ItemExtraDomain.ItemExtra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.ItemTaxDomain.ItemTax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.ItemVariationDomain.ItemVariation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.Items.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.Items.ItemBranch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.LanguageDomain.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.OfferDomain.OfferItem", b =>
                {
                    b.Property<int>("OfferId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wajba.ItemAddonDomain.ItemAddon", b =>
                {
                    b.HasOne("Wajba.Items.Item", "Item")
                        .WithMany("ItemAddons")
            ...
            modelBuilder.Entity("Wajba.ItemVariationDomain.ItemVariation", b =>
                {
                    b.HasOne("Wajba.ItemAttributeDomain.ItemAttribute", null)
                        .WithMany("ItemVariations")
                        .HasForeignKey("ItemAttributeId");

                    b.HasOne("Wajba.ItemAttributeDomain.ItemAttribute", "ItemAttributes")
                        .WithMany()
            ...
            modelBuilder.Entity("Wajba.Items.Item", b =>
                {
                    b.HasOne("Wajba.CategoriesDomain.Category", "Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Wajba.OfferDomain.OfferCategory", b =>
                {
                    ...
                    b.HasOne("Wajba.OfferDomain.Offer", "Offer")
                        .WithMany("OfferCategories")
